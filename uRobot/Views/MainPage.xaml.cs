...
namespace uRobot.Views
{
    ...
    public sealed partial class MainPage : Page, INotifyPropertyChanged
    {
        ...
        private string modelFileName = "FER.onnx";
        ...
        {
            StorageFile file = await StorageFile.GetFileFromApplicationUriAsync(new Uri($"ms-appx:///Assets/Classifier/{modelFileName}"));
        ...
        private async Task MoveRobot(ONNXModelOutput output)
        {
            ...
            {
                case "Angry":
                    await _robotController.SendAsync("R");
                    break;
                case "Happy":
                    await _robotController.SendAsync("L");
                    break;
                case "Neutral":
                    await _robotController.SendAsync("S");
                    break;
                default:
                    break;
            }
